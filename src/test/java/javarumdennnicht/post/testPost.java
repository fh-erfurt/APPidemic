...
public class testPost
{
   ...
   private final User user3 = new User("kalterdieter", "45454", "kalterdieter@web.de", "Dieter", "Kalt", LocalDate.of(2001,6,13));
    ...
    @Test
    public void before_submitting_a_post_it_will_not_appear_in_the_Posts_and_taggedPosts_ArrayLists_respectively()
    {
        // Given
        Profile profile1 = user1.getRelatedProfile();
        Profile profile2 = user2.getRelatedProfile();
        ...
        //Then
        assertEquals("The post should not yet be in the posts ArrayList for the author(profile1), since it was not submitted yet: ", 0,profile1.getPosts().size());
        assertEquals("The post should not yet be in the taggedPosts ArrayList for the tagged profile, since it was not submitted yet: ", 0,profile2.getTaggedPosts().size());
    }
