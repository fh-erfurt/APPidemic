...
public class testUser
{
    ...
    private final User     user    = new User("Havoc17","Katze123", "havoc17@gmail.com","Hannes", "Volker", LocalDate.of(2001,12,24));
    private final User     user2   = new User("ElricE", "Alfons456", "ElricEdward@gmx.com", "Edward", "Elric", LocalDate.of(1998,2,12));
    ...
    public void changing_email_successful()
    {
        ...
        // Then
        assertEquals("The email should have been changed", "email@gmail.com", user.getEMail());
    }
    ...
    public void changing_email_but_email_is_already_taken()
    {
        ...
        // Then
        assertEquals("The email should not be changed", "havoc17@gmail.com", user.getEMail());
    }
}
